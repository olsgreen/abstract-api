...
use Olsgreen\AbstractApi\Http\Exceptions\ClientException;
use Olsgreen\AbstractApi\Http\Exceptions\ForbiddenException;
use Olsgreen\AbstractApi\Http\Exceptions\HttpException;
use Olsgreen\AbstractApi\Http\Exceptions\ServerException;
use Olsgreen\AbstractApi\Http\Exceptions\TemporaryServerException;
use Olsgreen\AbstractApi\Http\Exceptions\UnauthorizedException;
